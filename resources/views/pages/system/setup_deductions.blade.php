...
@section('content')
    ...
    <div class="row myrow">
        ...
        <div class="input-field col-sm-5">
            ...
            <i class="material-icons left">add</i>Add Deduction</a>
        </div>  
    </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-sm-center">
                        <a class="waves-effect waves btn modal-trigger btn-abi emp_details_btn tooltipped" href="#modal1" data-tooltip="Update Deduction">
                            <i class="material-icons left">edit</i>
                        </a>
                        <a class="waves-effect waves btn btn-abi emp_details_btn tooltipped" href="#" data-tooltip="Remove Deduction">
